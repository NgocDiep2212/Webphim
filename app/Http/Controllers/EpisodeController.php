...
class EpisodeController extends Controller
{
    ...
    public function add_episode($id){
        ...
        return view('admincp.episode.add_episode',compact('list_ep','movie','linkmovie','list_server'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admincp.episode.form',compact('linkmovie', 'list_server','episode', 'list_movie'));
    }
